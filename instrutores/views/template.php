        ...
        <ul class="nav navbar-nav">
          <li class="dropdown user user-menu">
            <a class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo $_SESSION['LoginIns']['nome']; ?></span>
            </a>
          </li>
        </ul>
      </div>
    ...
    <section class="sidebar">
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header"><strong><small>MENU DE NAVEGAÇAO</small></strong></li>
          ...
          <li class="treeview active" style="cursor:pointer;">
            <a>
              <i class="fa fa-pencil-square-o"></i> <span>Relatórios</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li><a href="<?= BASE; ?>matriculado"><i class="fa fa-angle-right"></i> Alunos matriculados</a></li>
            </ul>
          </li>
          <li>
